...
export type AggregateReplyVote = {
  ...
  _avg: ReplyVoteAvgAggregateOutputType | null
  _sum: ReplyVoteSumAggregateOutputType | null
  _min: ReplyVoteMinAggregateOutputType | null
  _max: ReplyVoteMaxAggregateOutputType | null
}

export type ReplyVoteAvgAggregateOutputType = {
  voteId: number | null
  replyId: number | null
}

export type ReplyVoteSumAggregateOutputType = {
  voteId: number | null
  replyId: number | null
}
...
export type ReplyVoteAvgAggregateInputType = {
  voteId?: true
  replyId?: true
}

export type ReplyVoteSumAggregateInputType = {
  voteId?: true
  replyId?: true
}
...
export type ReplyVoteAggregateArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
  ...
  **/
  _avg?: ReplyVoteAvgAggregateInputType
  /**
   * {@link https://www.prisma.io/docs/concepts/components/prisma-client/aggregations Aggregation Docs}
   * 
   * Select which fields to sum
  **/
  _sum?: ReplyVoteSumAggregateInputType
  /**
   * {@link https://www.prisma.io/docs/concepts/components/prisma-client/aggregations Aggregation Docs}
   * 
...
export type GetReplyVoteGroupByPayload<T extends ReplyVoteGroupByArgs> = Prisma.PrismaPromise<
  Array<
...
export type ReplyVoteWhereInput = {
  ...
  voteId?: Prisma.IntFilter<"ReplyVote"> | number
  replyId?: Prisma.IntFilter<"ReplyVote"> | number
  userId?: Prisma.StringFilter<"ReplyVote"> | string
  voteType?: Prisma.EnumVoteTypeFilter<"ReplyVote"> | $Enums.VoteType
  createdAt?: Prisma.DateTimeFilter<"ReplyVote"> | Date | string
  reply?: Prisma.XOR<Prisma.ReviewReplyScalarRelationFilter, Prisma.ReviewReplyWhereInput>
}
...
export type ReplyVoteWhereUniqueInput = Prisma.AtLeast<{
  voteId?: number
  replyId_userId?: Prisma.ReplyVoteReplyIdUserIdCompoundUniqueInput
  AND?: Prisma.ReplyVoteWhereInput | Prisma.ReplyVoteWhereInput[]
  OR?: Prisma.ReplyVoteWhereInput[]
  NOT?: Prisma.ReplyVoteWhereInput | Prisma.ReplyVoteWhereInput[]
  replyId?: Prisma.IntFilter<"ReplyVote"> | number
...
export type ReplyVoteOrderByWithAggregationInput = {
  ...
  _avg?: Prisma.ReplyVoteAvgOrderByAggregateInput
  _max?: Prisma.ReplyVoteMaxOrderByAggregateInput
  _min?: Prisma.ReplyVoteMinOrderByAggregateInput
  _sum?: Prisma.ReplyVoteSumOrderByAggregateInput
}
...
export type ReplyVoteScalarWhereWithAggregatesInput = {
  ...
  voteId?: Prisma.IntWithAggregatesFilter<"ReplyVote"> | number
  replyId?: Prisma.IntWithAggregatesFilter<"ReplyVote"> | number
  userId?: Prisma.StringWithAggregatesFilter<"ReplyVote"> | string
  voteType?: Prisma.EnumVoteTypeWithAggregatesFilter<"ReplyVote"> | $Enums.VoteType
  createdAt?: Prisma.DateTimeWithAggregatesFilter<"ReplyVote"> | Date | string
}
...
export type ReplyVoteCreateInput = {
  ...
  reply: Prisma.ReviewReplyCreateNestedOneWithoutVotesInput
}
...
export type ReplyVoteUpdateInput = {
  ...
  reply?: Prisma.ReviewReplyUpdateOneRequiredWithoutVotesNestedInput
}

export type ReplyVoteUncheckedUpdateInput = {
  voteId?: Prisma.IntFieldUpdateOperationsInput | number
...
export type ReplyVoteReplyIdUserIdCompoundUniqueInput = {
  replyId: number
  userId: string
}
...
export type ReplyVoteAvgOrderByAggregateInput = {
  voteId?: Prisma.SortOrder
  replyId?: Prisma.SortOrder
}
...
export type ReplyVoteSumOrderByAggregateInput = {
  voteId?: Prisma.SortOrder
  replyId?: Prisma.SortOrder
}
...
export type ReplyVoteSelect<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetSelect<{
  ...
  voteType?: boolean
  createdAt?: boolean
  reply?: boolean | Prisma.ReviewReplyDefaultArgs<ExtArgs>
...
export type ReplyVoteOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"voteId" | "replyId" | "userId" | "voteType" | "createdAt", ExtArgs["result"]["replyVote"]>
...
export type ReplyVoteCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<ReplyVoteFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface ReplyVoteDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const replyVoteWithVoteIdOnly = await prisma.replyVote.findMany({ select: { voteId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many ReplyVotes and only return the `voteId`
   * const replyVoteWithVoteIdOnly = await prisma.replyVote.createManyAndReturn({
   *   select: { voteId: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more ReplyVotes and only return the `voteId`
   * const replyVoteWithVoteIdOnly = await prisma.replyVote.updateManyAndReturn({
   *   select: { voteId: true },
   *   where: {
   *     // ... provide filter here
   *   },
  ...
  **/
  ...
  >(args: Prisma.SubsetIntersection<T, ReplyVoteGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetReplyVoteGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
...
export interface Prisma__ReplyVoteClient<T, Null = never, ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> extends Prisma.PrismaPromise<T> {
  ...
  reply<T extends Prisma.ReviewReplyDefaultArgs<ExtArgs> = {}>(args?: Prisma.Subset<T, Prisma.ReviewReplyDefaultArgs<ExtArgs>>): Prisma.Prisma__ReviewReplyClient<runtime.Types.Result.GetResult<Prisma.$ReviewReplyPayload<ExtArgs>, T, "findUniqueOrThrow", GlobalOmitOptions> | Null, Null, ExtArgs, GlobalOmitOptions>
  /**
...
export interface ReplyVoteFieldRefs {
  readonly voteId: Prisma.FieldRef<"ReplyVote", 'Int'>
  readonly replyId: Prisma.FieldRef<"ReplyVote", 'Int'>
  readonly userId: Prisma.FieldRef<"ReplyVote", 'String'>
  readonly voteType: Prisma.FieldRef<"ReplyVote", 'VoteType'>
  readonly createdAt: Prisma.FieldRef<"ReplyVote", 'DateTime'>
}
